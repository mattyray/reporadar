...
def cleanup_old_analytics():
    ...
    ev_deleted, _ = Event.objects.filter(created_at__lt=cutoff).delete()
    ...
    return f"Deleted {pv_deleted} page views, {ev_deleted} events, {s_deleted} sessions, {ae_deleted} auth events older than 90 days"
